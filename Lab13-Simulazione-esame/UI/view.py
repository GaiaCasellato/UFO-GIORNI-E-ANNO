...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.ddanno = ft.TextField(label="Anno", on_submit=self._controller.handle_anno)
        self.ddgiorni = ft.TextField(label="Giorni", on_submit=self._controller.handlegiorni)
        ...
        row1 = ft.Row([self.ddanno,self.ddgiorni, self.btn_graph],
